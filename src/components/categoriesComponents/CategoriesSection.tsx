...
export const CategoriesSection = () => {
  return (
    <section className="mt-16">
      <SecondarySectionTitle secondaryTitle="Categories" />
      <div className="flex items-center justify-between mt-5">
        <SectionsTitles sectionTitle="Browse By Category" />
          ...
          <button className="cursor-pointer transition-transform duration-300 hover:scale-110">
            ...
            >
              ...
              <path
                ...
                className="stroke-black group-hover:stroke-white transition-colors duration-200"
                stroke-width="2"
      ...
      <div className="flex gap-8 mt-14">
        <div className="group flex flex-col gap-2.5 justify-center items-center w-[170px] h-[145px] border-2 border-[#0000003b] hover:border-[#DB4444] rounded-[4px] cursor-pointer hover:bg-[#DB4444] transition-transform duration-300 hover:scale-105">
          <svg
            width="56"
            height="56"
            viewBox="0 0 56 56"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_19744_868)">
              <path
        ...
        <div className="group flex flex-col gap-2.5 justify-center items-center w-[170px] h-[145px] border-2 border-[#0000003b] hover:border-[#DB4444] rounded-[4px] cursor-pointer hover:bg-[#DB4444] transition-transform duration-300 hover:scale-105">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_19744_613)">
              <path
        ...
        <div className="group flex flex-col gap-2.5 justify-center items-center w-[170px] h-[145px] border-2 border-[#0000003b] hover:border-[#DB4444] rounded-[4px] cursor-pointer hover:bg-[#DB4444] transition-transform duration-300 hover:scale-105">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_19744_629)">
              <path
        ...
        <div className="group flex flex-col gap-2.5 justify-center items-center w-[170px] h-[145px] border-2 border-[#0000003b] hover:border-[#DB4444] rounded-[4px] cursor-pointer hover:bg-[#DB4444] transition-transform duration-300 hover:scale-105">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_19744_644)">
              <path
        ...
        <div className="group flex flex-col gap-2.5 justify-center items-center w-[170px] h-[145px] border-2 border-[#0000003b] hover:border-[#DB4444] rounded-[4px] cursor-pointer hover:bg-[#DB4444] transition-transform duration-300 hover:scale-105">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_19744_809)">
              <path
