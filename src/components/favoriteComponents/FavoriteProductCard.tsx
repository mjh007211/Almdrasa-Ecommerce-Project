...
export const FavoriteProductCard = ({
  ...
  const handleRemoveFavoriteProduct = () => {
    ...
    const updateUsers: ProductsData[] = getStoredUsers.map((u) =>
      u.isLogin === true
        ? {
            ...u,
            favoriteProducts: updateUserFavoriteProductList,
          }
        : u
    );
  ...
  return (
    <div>
      <div className="relative flex flex-col justify-center items-center bg-[#f5f5f5] rounded-[4px] w-[270px] h-[250px]">
        {discount && (
      ...
      <div className="flex flex-col gap-2 font-medium mt-2.5">
        ...
        <div className="flex gap-2.5">
          <span className="text-[#DB4444]">${originalProductPrice}</span>
          {discountedProductPrice ? (
