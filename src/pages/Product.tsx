      ...
      <div className="flex justify-between mt-17">
        ...
        <div className="w-[400px]">
          ...
          <div className="flex items-center gap-6 mt-5">
            <span className="font-Inter text-[20px]">Colours: </span>
            <svg
              width="48"
              height="20"
              viewBox="0 0 48 20"
          ...
          <div className="flex gap-6 mt-5">
            <span className="font-Inter text-[20px]">Size: </span>
            <svg
              width="226"
              height="34"
              viewBox="0 0 226 34"
            ...
            >
              ...
              />
              <path
                d="M13.516 17.142L16.54 22H14.748L12.55 18.472L10.492 22H8.714L11.738 17.142L8.7 12.27H10.492L12.704 15.826L14.776 12.27H16.554L13.516 17.142ZM21.4982 22.098C20.8449 22.098 20.2569 21.986 19.7342 21.762C19.2115 21.5287 18.8009 21.202 18.5022 20.782C18.2035 20.362 18.0542 19.872 18.0542 19.312H19.7622C19.7995 19.732 19.9629 20.0773 20.2522 20.348C20.5509 20.6187 20.9662 20.754 21.4982 20.754C22.0489 20.754 22.4782 20.6233 22.7862 20.362C23.0942 20.0913 23.2482 19.746 23.2482 19.326C23.2482 18.9993 23.1502 18.7333 22.9542 18.528C22.7675 18.3227 22.5295 18.164 22.2402 18.052C21.9602 17.94 21.5682 17.8187 21.0642 17.688C20.4295 17.52 19.9115 17.352 19.5102 17.184C19.1182 17.0067 18.7822 16.736 18.5022 16.372C18.2222 16.008 18.0822 15.5227 18.0822 14.916C18.0822 14.356 18.2222 13.866 18.5022 13.446C18.7822 13.026 19.1742 12.704 19.6782 12.48C20.1822 12.256 20.7655 12.144 21.4282 12.144C22.3709 12.144 23.1409 12.382 23.7382 12.858C24.3449 13.3247 24.6809 13.9687 24.7462 14.79H22.9822C22.9542 14.4353 22.7862 14.132 22.4782 13.88C22.1702 13.628 21.7642 13.502 21.2602 13.502C20.8029 13.502 20.4295 13.6187 20.1402 13.852C19.8509 14.0853 19.7062 14.4213 19.7062 14.86C19.7062 15.1587 19.7949 15.406 19.9722 15.602C20.1589 15.7887 20.3922 15.938 20.6722 16.05C20.9522 16.162 21.3349 16.2833 21.8202 16.414C22.4642 16.5913 22.9869 16.7687 23.3882 16.946C23.7989 17.1233 24.1442 17.3987 24.4242 17.772C24.7135 18.136 24.8582 18.626 24.8582 19.242C24.8582 19.7367 24.7229 20.2033 24.4522 20.642C24.1909 21.0807 23.8035 21.4353 23.2902 21.706C22.7862 21.9673 22.1889 22.098 21.4982 22.098Z"
                fill="black"
              />
              <rect
                x="48.5"
              ...
              />
              <path
                d="M65.256 22.098C64.6027 22.098 64.0147 21.986 63.492 21.762C62.9693 21.5287 62.5587 21.202 62.26 20.782C61.9613 20.362 61.812 19.872 61.812 19.312H63.52C63.5573 19.732 63.7207 20.0773 64.01 20.348C64.3087 20.6187 64.724 20.754 65.256 20.754C65.8067 20.754 66.236 20.6233 66.544 20.362C66.852 20.0913 67.006 19.746 67.006 19.326C67.006 18.9993 66.908 18.7333 66.712 18.528C66.5253 18.3227 66.2873 18.164 65.998 18.052C65.718 17.94 65.326 17.8187 64.822 17.688C64.1873 17.52 63.6693 17.352 63.268 17.184C62.876 17.0067 62.54 16.736 62.26 16.372C61.98 16.008 61.84 15.5227 61.84 14.916C61.84 14.356 61.98 13.866 62.26 13.446C62.54 13.026 62.932 12.704 63.436 12.48C63.94 12.256 64.5233 12.144 65.186 12.144C66.1287 12.144 66.8987 12.382 67.496 12.858C68.1027 13.3247 68.4387 13.9687 68.504 14.79H66.74C66.712 14.4353 66.544 14.132 66.236 13.88C65.928 13.628 65.522 13.502 65.018 13.502C64.5607 13.502 64.1873 13.6187 63.898 13.852C63.6087 14.0853 63.464 14.4213 63.464 14.86C63.464 15.1587 63.5527 15.406 63.73 15.602C63.9167 15.7887 64.15 15.938 64.43 16.05C64.71 16.162 65.0927 16.2833 65.578 16.414C66.222 16.5913 66.7447 16.7687 67.146 16.946C67.5567 17.1233 67.902 17.3987 68.182 17.772C68.4713 18.136 68.616 18.626 68.616 19.242C68.616 19.7367 68.4807 20.2033 68.21 20.642C67.9487 21.0807 67.5613 21.4353 67.048 21.706C66.544 21.9673 65.9467 22.098 65.256 22.098Z"
                fill="black"
              />
              <rect x="97" y="1" width="32" height="32" rx="4" fill="#DB4444" />
              <path
                d="M118.298 12.27V22H116.702V15.336L113.734 22H112.628L109.646 15.336V22H108.05V12.27H109.772L113.188 19.9L116.59 12.27H118.298Z"
                fill="#FAFAFA"
              />
              <rect
                x="144.5"
              ...
              />
              <path
                d="M160.646 20.712H163.936V22H159.05V12.27H160.646V20.712Z"
                fill="black"
              />
              <rect
                x="192.5"
              ...
              />
              <path
                d="M206.516 17.142L209.54 22H207.748L205.55 18.472L203.492 22H201.714L204.738 17.142L201.7 12.27H203.492L205.704 15.826L207.776 12.27H209.554L206.516 17.142ZM212.888 20.712H216.178V22H211.292V12.27H212.888V20.712Z"
                fill="black"
              />
            </svg>
          </div>

          <div className="flex justify-between items-center h-[44px] mt-10">
            <svg
              width="159"
              height="44"
              viewBox="0 0 159 44"
            ...
            >
              <path
                d="M4 0.5H39.5V43.5H4C2.067 43.5 0.5 41.933 0.5 40V4C0.5 2.067 2.067 0.5 4 0.5Z"
                stroke="black"
                stroke-opacity="0.5"
              />
              <path
            ...
            <div className="h-[100%]">
              <ButtonComponent text="Buy Now" width={165} />
            </div>
            <svg
              width="42"
              height="42"
          ...
          <div className="border rounded-[4px] mt-9">
            <div className="flex gap-4 items-center border-b py-5 px-2.5">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
              ...
              <div className="flex flex-col">
                ...
                <p className="font-medium text-[12px] underline">
                  Enter your postal code for Delivery Availability
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-center py-5 px-2.5">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
